...
public class BankStatementLoaderFactory implements IBankStatementLoaderFactory {

	/**
	 * default constructor 
	 */
	public BankStatementLoaderFactory() {
	}

	@Override
	public BankStatementLoaderInterface newBankStatementLoaderInstance(String className) {
		if (CAMT053Loader.class.getName().equals(className)) {
			return new CAMT053Loader();
		}
		return null;
	}
